...
DATA_PATH = Path(__file__).resolve().parent / "client_8.xlsx"
...
def run_client8(feature_columns, global_weights=None):
    ...
    np.savez(
        output_dir / "client_8_output.npz",
    ...
    print(f"Client 8 output saved to {output_dir / 'client_8_output.npz'}")
