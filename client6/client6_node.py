...
DATA_PATH = Path(__file__).resolve().parent / "client_6.xlsx"
...
def run_client6(feature_columns, global_weights=None):
    ...
    np.savez(
        output_dir / "client_6_output.npz",
    ...
    print(f"Client 6 output saved to {output_dir / 'client_6_output.npz'}")
