...
np.savez(
    "../client_output/client_7_output.npz",
...
print("Client 7 output saved to ../client_output/client_7_output.npz")

print("\nModel Weights Shape:", model.coef_.shape)
print("Number of Training Samples:", len(X_train))

print("Male samples:", male_idx.sum())

print("Female samples:", female_idx.sum())