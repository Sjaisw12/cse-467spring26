...
DATA_PATH = Path(__file__).resolve().parent / "client_10.xlsx"
...
def run_client10(feature_columns, global_weights=None):
    ...
    np.savez(
        output_dir / "client_10_output.npz",
    ...
    print(f"Client 10 output saved to {output_dir / 'client_10_output.npz'}")
